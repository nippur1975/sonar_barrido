...
class SonarEchoSimulator:
    ...
    def render_sweep(self, current_sweep_radius_px, sweep_speed_px_per_frame, noise_limit_level=0):
        ...
        if np.any(mascara):
            ...
            # Level 2 -> Threshold ~1.2 (Reducción suave de fondo)
            # Level 8 -> Threshold ~4.8 (Elimina azules, respeta el eco)
            # Level 10 -> Threshold 6.0 (Elimina hasta cyan suave)
            if noise_limit_level > 0:
                threshold = noise_limit_level * 0.6
