...
TRANSLATIONS = {
    ...
    'JAPANESE': { # Japanese (Katakana/English mix)
        'LBL_LAT_LON': 'LAT / LON',
        'LBL_SHIP_SPEED': 'SHIP SPEED',
        'LBL_SHIP_COURSE': 'SHIP COURSE',
        'LBL_ALARM': 'ALARM!',
        'MSG_SPEED_WARNING': 'Max allowable speed during raising transducer is 16 kt',
        'TAB_SONAR': 'SONAR',
        'TAB_SOUNDER': 'GYOTAN', # Fishfinder
        'TAB_MARKS': 'MARK',
        'TAB_SYSTEM': 'SYSTEM',
        'LBL_PRESENT_MODE': 'HYOJI MODE',
        'LBL_TX_POWER': 'TX POWER',
        'LBL_PULSE_LENGTH': 'PULSE HABA',
        'LBL_TX_CYCLE': 'TX CYCLE',
        'LBL_TVG_NEAR': 'TVG NEAR',
        'LBL_TVG_FAR': 'TVG FAR',
        'LBL_AGC': 'AGC',
        'LBL_2ND_AGC': '2ND AGC',
        'LBL_NOISE_LIMIT': 'NOISE LIMIT',
        'LBL_COLOR_CURVE': 'COLOR CURVE',
        'LBL_COLOR_RESPONSE': 'COLOR RESP',
        'LBL_COLOR_ERASE': 'COLOR ERASE',
        'LBL_ECHO_AVG': 'ECHO AVG',
        'LBL_INTERF_REJECT': 'INT REJECT',
        'LBL_HORIZ_BEAM': 'SUIHEI BEAM',
        'LBL_VERT_BEAM': 'SUIJIKU BEAM',
        'LBL_COLOR': 'COLOR',
        'LBL_DELETE_MARKS': 'MARK SAKUJO',
        'LBL_ALARM_LEVEL': 'ALARM LEVEL',
        'LBL_AUTO_SEARCH': 'AUTO SEARCH',
        'LBL_SEARCH_SECTOR': 'SEARCH SECTOR',
        'LBL_AUTO_TILT': 'AUTO TILT',
        'LBL_TILT_ANGLE': 'TILT ANGLE',
        'LBL_TRANSMISSION': 'SOSHIN',
        'LBL_AUDIO_VOL': 'AUDIO VOL',
        'LBL_ASSIGN_F_KEY': 'F-KEY SET',
        'LBL_ASSIGN_MENU': 'MENU SET',
        'LBL_RING_DIST': 'RING DIST',
        'LBL_BEARING_SCALE': 'HOI SCALE',
        'LBL_CURRENT_VEC': 'CHORYU VEC',
        'LBL_CURRENT_DIR': 'CHORYU HOI',
        'LBL_SHIP_TRACK': 'KOUSEKI',
        'LBL_HEADING': 'HEADING',
        'LBL_BOW_HEADING': 'BOW HEADING',
        'LBL_CURRENT_DATA': 'CURRENT DATA',
        'LBL_EVENT_FISH': 'EVENT/FISH',
        ...
        'LBL_GAIN': 'GAIN',
        'LBL_CLUTTER': 'CLUTTER',
        'LBL_PIC_ADVANCE': 'GAZO OKURI',
        'LBL_DRAFT_ADJ': 'KISSUI ADJ',
        'LBL_DIMMER': 'DIMMER',
        'LBL_DISP_SELECT': 'DISP SELECT',
        'LBL_HEADING_ADJ': 'HOI ADJ',
        'LBL_AUTO_RETRACT': 'AUTO RETRACT',
        'LBL_SPEED_MSG': 'SPEED MSG',
        'LBL_EXT_SYNC': 'EXT SYNC',
        'LBL_AUTO_SEARCH_SPD': 'A-SEARCH SPD',
        'LBL_AUTO_TILT_SPD': 'A-TILT SPD',
        'LBL_UNIT': 'UNIT',
        'LBL_SPEED_COURSE': 'SPD / CRS',
        'LBL_LOG_PULSE': 'LOG PULSE',
        'LBL_COM_PORT': 'COM PORT',
        'LBL_PORT_FORMAT': 'PORT FORMAT',
        'LBL_PORT_BAUD': 'PORT BAUD',
    ...
    'KOREAN': { # Korean (Transliterated/English mix)
        'LBL_LAT_LON': 'LAT / LON',
        'LBL_SHIP_SPEED': 'SEONBAK SOKDO',
        'LBL_SHIP_COURSE': 'SEONBAK CHIMRO',
        'LBL_ALARM': 'ALARM!',
        'MSG_SPEED_WARNING': 'Max allowable speed during raising transducer is 16 kt',
        'TAB_SONAR': 'SONAR',
        'TAB_SOUNDER': 'EOTAAM',
        'TAB_MARKS': 'MARK',
        'TAB_SYSTEM': 'SYSTEM',
        'LBL_PRESENT_MODE': 'PYOSI MODE',
        'LBL_TX_POWER': 'TX POWER',
        'LBL_PULSE_LENGTH': 'PULSE GIRI',
        'LBL_TX_CYCLE': 'TX CYCLE',
        'LBL_TVG_NEAR': 'TVG NEAR',
        'LBL_TVG_FAR': 'TVG FAR',
        'LBL_AGC': 'AGC',
        ...
        'LBL_ECHO_AVG': 'ECHO AVG',
        'LBL_INTERF_REJECT': 'INT REJECT',
        'LBL_HORIZ_BEAM': 'SU-PYUNG BEAM',
        'LBL_VERT_BEAM': 'SU-JIK BEAM',
        'LBL_COLOR': 'COLOR',
        'LBL_DELETE_MARKS': 'MARK SAKJE',
        'LBL_ALARM_LEVEL': 'ALARM LEVEL',
        'LBL_AUTO_SEARCH': 'AUTO SEARCH',
        'LBL_SEARCH_SECTOR': 'SEARCH SECTOR',
        'LBL_AUTO_TILT': 'AUTO TILT',
        'LBL_TILT_ANGLE': 'TILT ANGLE',
        'LBL_TRANSMISSION': 'SONG-SIN',
        'LBL_AUDIO_VOL': 'AUDIO VOL',
        'LBL_ASSIGN_F_KEY': 'F-KEY SET',
        'LBL_ASSIGN_MENU': 'MENU SET',
        'LBL_RING_DIST': 'RING DIST',
        'LBL_BEARING_SCALE': 'BANG-WI SCALE',
        'LBL_CURRENT_VEC': 'JORYU VEC',
        'LBL_CURRENT_DIR': 'JORYU BANG',
        'LBL_SHIP_TRACK': 'HANGJEOK',
        'LBL_HEADING': 'HEADING',
        'LBL_BOW_HEADING': 'BOW HEADING',
        'LBL_CURRENT_DATA': 'CURRENT DATA',
        'LBL_EVENT_FISH': 'EVENT/FISH',
...
class MenuSystem:
            ...
            for i, item in enumerate(active_layout):
                ...
                if item['type'] == 'selector':
                    ...
                    for val in item['values']:
                        val_surf = self.font_item_value.render(str(self.tr_val(val)), True, self.color_text_light)
    ...
    def _draw_tab(self, surface, layout):
        ...
        for i, item in enumerate(layout):
            ...
            label_surf = self.font_item_label.render(label_text, True, self.color_text_light)
